DATA = 
	...
	experience: [
		...
		,
			...
			description	: "It's the perfect thing for anyone new to the net or is just a bit web-rubbish. So if you know any one flummoxed by tweets, links and pokes or who'd appreciate learning how to email, Skype, or shop online, why not set them up with a page of Internet Buttons today?"
			tasks		: 
				'System Architecture'
				'Database Design'
				'Client Side (PHP/MySQL using MVC framework)'
